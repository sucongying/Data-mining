...
# 说明
## 文件说明
在代码+数据文件夹中**data1.csv**为数据源1，**data2.csv**为数据源2，**result.csv**为直接将两个数据源合并的结果（未数清洗），运行结果截图或运行结果文件文件夹中**result(washed).csv**为数据清洗完后导出的结果，且之后实验题目数据均采用**result(washed).csv**
## 函数说明
**填充缺失值**
